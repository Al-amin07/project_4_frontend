        ...
        >
            <div className="flex items-center justify-center w-full h-full bg-gray-900/10">
                <div className="text-center">
                    ...
                    <p className="my-6 w-full md:w-3/4 mx-auto text-lg md:text-xl text-gray-100">
                        Explore our exclusive collection of luxury and sports cars at unbeatable prices.
                    </p>

                    {/* Call-to-Action Button */}
                    <Link to={'/all-product'} className="mt-6 px-6 py-2 bg-red-600 hover:bg-red-700 text-white text-lg font-medium rounded-full transition-all">
                        Browse Cars
                    </Link>
                </div>
            </div>
